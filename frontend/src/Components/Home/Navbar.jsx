      ...
      <div className="nav__container">
        <div className="nav__header">
          ...
          <img src="../assets/logo.png" alt="" />
            <Link to="/">
              <span className="logo__text">SEWIST</span>
            </Link>
          </div>
        ...
        <ul className={`nav__links ${menuOpen ? "open" : ""}`}>
          ...
          <li className="nav__item">
            <Link to="/nutrition" className="nav__link">Patterns</Link>
          </li>
          <li className="nav__item">
          ...
          <li className="nav__item nav__item--cta">
            {isLoggedIn ? (
              <Link to="../community" className="nav__link nav__link--cta">Dashboard</Link>
            ) : (
